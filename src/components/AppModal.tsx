...
const AppModal = ({ title, children }: AppModalProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute min-w-[min(330px,95vw)] app-theme rounded-lg border app-borders shadow-lg app-shadows py-3 bottom-20 lg:top-1/2 left-1/2 -translate-x-1/2 lg:-translate-y-1/2">
